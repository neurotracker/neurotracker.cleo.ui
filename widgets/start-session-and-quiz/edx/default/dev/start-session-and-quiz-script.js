jQuery('#js-start-widget').html(`
  <div id="js-start-session__container" class="start-session__container">
    <div class="start-session__header">
        <div class="start-session__title i18n-welcome-back"></div>
    </div>
    <div class="start-session__content">
      ...
      <div id="js-start-session__goal-message" class="start-session__goal-message">
          <span class="i18n-your-goal"></span>
          <i id="js-start-session__goal-icon" class="fas fa-angle-right"></i>
      </div>
      <span class="start-session__session-info">
          <span class="start-session__session-info-block"><span class="start-session__goal-num" id="js-start-session__goal-targets"></span><span class="start-session__target-info i18n-targets"></span></span>
          <span class="start-session__session-info-block"><span class="start-session__goal-num" id="js-start-session__goal-seconds"></span><span class="start-session__second-info i18n-seconds"></span></span>
      </span>
      <span class="start-session__start-content">
        <div class="start-session__start-msg i18n-ready"></div>
        <button id= "js-start-session__start-btn" class="start-session__start-btn i18n-start"></button>
      </span>
    </div>
  </div>
  <form id="js-quiz__form" action="" method="post" class="quiz__container quiz__container--hidden">
    ...
    <div class="quiz__question-prompt i18n-just-a-few-questions"></div>
    ...
    <div id="js-quiz__question1" class="quiz__question-container js-quiz__question-container">
      <div class="quiz__question i18n-how-are-you-feeling"></div>
    ...
    <div id="js-quiz__question2" class="quiz__question-container js-quiz__question-container">
      <div class="quiz__question i18n-which-of-these-match-your-mood"></div>
      <div class="quiz__answers--mood">
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-happy"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-sad"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-excited"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-upset"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-nervous"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-alert"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-relaxed"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-calm"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-stressed"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-depressed"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-serene"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-contented"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-lethargic"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-fatigued"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-elated"></div></div>
        <div class="js-quiz__answer--mood quiz__answer--mood"><div class="i18n-tense"></div></div>
      </div>
    </div>
    ...
    <div id="js-quiz__question3" class="quiz__question-container js-quiz__question-container">
        <div class="quiz__subquestion-container">
          <div class="quiz__subquestion i18n-how-many-hours-of-sleep"></div>
        ...
        <hr>
        <div class="quiz__subquestion-container">
          <div class="quiz__subquestion i18n-have-you-eaten-in-the-last-2-hours"></div>
          <div class="quiz__subquestion-answers">
        ...
        <hr>
        <div class="quiz__subquestion-container">
          <div class="quiz__subquestion i18n-have-you-exercised-in-the-last-2-hours"></div>
            <div class="quiz__subquestion-answers">
      ...
      <div class="quiz__nav-btns">
        <button type="button" id="js-quiz__go-back" class="quiz__go-back i18n-back"></button>
        <button type="button" id="js-quiz__go-next" class="quiz__go-next i18-next"></button>
      </div>
      </div>
  </form>
`);
...
function showQuestion(n) {
  ...
  if(n == (questionIds.length - 1)) {
    goNext.text(globalize.messageFormatter('submit')()); 
  } else {
    goNext.text(globalize.messageFormatter('next')());
  }
}
